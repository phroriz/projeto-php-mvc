        ...
        <div class="row">
            ...
            <div class="column side pr-5">
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <?=$user->ageYears.' anos e '.$user->ageMonths.' meses';?> <br /> (<?=date('d/m/Y', strtotime($user->birthdate))?>)
                        </div>
            ...
            <div class="column pl-5">
                            ...
                            <?php if(isset($user->photos[$q])):?>
                                <div class="user-photo-item">
                                    ...
                                    <div id="modal-<?=$user->photos[$q]->id?>" style="display:none">
                                        <img src="media/uploads/<?=$user->photos[$q]->body?>" />
                                    </div>
                                </div>
                            <?php endif ?>
                        <?php endfor ?>
                ...
                <div class="feed-pagination">
                    <?php for($q = 1; $q < $feed['pageCount']; $q++): ?>
                        <a class="<?=($q == $feed['correntPage']) ? 'active' : ''?>" href="<?=$base?>/perfil/<?=$user->id?>?page=<?=$q?>"><?=$q?></a>
                    <?php endfor ?>
                </div>
